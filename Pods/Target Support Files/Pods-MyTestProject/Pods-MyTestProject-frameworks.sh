...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DHDateFormatter/DHDateFormatter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DoraemonKit/DoraemonKit.framework"
  install_framework "${PODS_ROOT}/LC-SnapKit/SnapKit/SnapKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LCLogManager/LCLogManager.framework"
